# BIG-IP Declarative WAF v17.0 Schema

## 目錄

- [BIG-IP Declarative WAF v17.0 SchemaÂ¶](#big-ip-declarative-waf-v170-schemaâ)


Version notice:

# BIG-IP Declarative WAF v17.0 SchemaÂ¶

Download v17.0 schema
                           ...
                           "properties" : {
                              "detectUsernameFromLoginPages" : {
                                 "items" : {
                                    "properties" : {
                                       "loginPage" : {
                                          "$ref" : "#/properties/policy/properties/login-pages/oneOf/0/items",
                                          "type" : "object"
                                       }
                                    },
                                    "required" : [
               ...
               "oneOf" : [
                  {
                     "items" : {
                        "properties" : {
                           ...
                           "jsonProfile" : {
                              "$ref" : "#/properties/policy/properties/json-profiles/oneOf/0/items",
                              "type" : "object"
                           },
                           ...
                           "plainTextProfile" : {
                              "$ref" : "#/properties/policy/properties/plain-text-profiles/oneOf/0/items",
                              "type" : "object"
                           },
                           "protocol" : {
                              "enum" : [
                           ...
                           "validationFiles" : {
                              "items" : {
                                 "properties" : {
                                    ...
                                    "xmlValidationFile" : {
                                       "$ref" : "#/properties/policy/properties/xml-validation-files/oneOf/0/items",
                                       "type" : "object"
                                    }
                                 },
                                 "required" : [
